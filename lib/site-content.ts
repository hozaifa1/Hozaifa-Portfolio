...
export type SpecialtyPill = {
  ...
  label: string;
  tone: string;
  // Horizontal placement only — vertical placement is anchored to the pill's own
  // row at render time so bubbles always center on their label (no global drift).
  style: {
    left?: string;
    right?: string;
  };
...
export const specialtyPills: SpecialtyPill[] = [
  { row: 0, label: 'PyTorch', tone: 'pill-lavender', style: { left: '8%' } },
  { row: 0, label: 'Deep Learning', tone: 'pill-yellow', style: { right: '4%' } },
  { row: 0, label: 'Tandem Networks', tone: 'pill-mint', style: { left: '42%' } },
  { row: 0, label: 'Scikit-learn', tone: 'pill-metal', style: { right: '30%' } },
  { row: 0, label: 'Predictive Modeling', tone: 'pill-red', style: { left: '18%' } },
  { row: 1, label: 'OpenCV', tone: 'pill-red', style: { left: '5%' } },
  { row: 1, label: 'Pose Estimation', tone: 'pill-gold', style: { right: '8%' } },
  { row: 1, label: 'CNNs', tone: 'pill-mint', style: { left: '46%' } },
  { row: 1, label: 'FDTD Simulation', tone: 'pill-lavender', style: { right: '34%' } },
  { row: 1, label: 'CLIP', tone: 'pill-cream', style: { left: '22%' } },
  { row: 2, label: 'GPT-4o', tone: 'pill-yellow', style: { left: '10%' } },
  { row: 2, label: 'BERT', tone: 'pill-red', style: { right: '12%' } },
  { row: 2, label: 'Vector Search', tone: 'pill-lavender', style: { left: '40%' } },
  { row: 2, label: 'Embeddings', tone: 'pill-metal', style: { right: '38%' } },
  { row: 2, label: 'Transformers', tone: 'pill-mint', style: { left: '20%' } },
  { row: 3, label: 'Docker', tone: 'pill-mint', style: { left: '6%' } },
  { row: 3, label: 'FastAPI', tone: 'pill-lavender', style: { right: '6%' } },
  { row: 3, label: 'GCP', tone: 'pill-gold', style: { left: '44%' } },
  { row: 3, label: 'RabbitMQ', tone: 'pill-red', style: { right: '32%' } },
  { row: 3, label: 'ClickHouse', tone: 'pill-yellow', style: { left: '24%' } },
  { row: 4, label: 'Next.js', tone: 'pill-lavender', style: { left: '8%' } },
  { row: 4, label: 'TypeScript', tone: 'pill-red', style: { right: '10%' } },
  { row: 4, label: 'Django REST', tone: 'pill-metal', style: { left: '38%' } },
  { row: 4, label: 'NestJS', tone: 'pill-mint', style: { right: '36%' } },
  { row: 4, label: 'PostgreSQL', tone: 'pill-yellow', style: { left: '18%' } },
  { row: 5, label: 'GAAFET', tone: 'pill-red', style: { left: '6%' } },
  { row: 5, label: 'Device Physics', tone: 'pill-lavender', style: { right: '8%' } },
  { row: 5, label: 'TCAD', tone: 'pill-mint', style: { left: '42%' } },
  { row: 5, label: 'FinFET', tone: 'pill-gold', style: { right: '32%' } },
];
